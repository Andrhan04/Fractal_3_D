...
if os.path.isdir(Bufer):
    ...
    if fname.lower().endswith(".txt"):
        ...
        for i in range(len(x) - 1):
            ...
            # Draw side surface
            axes.add_collection3d(Poly3DCollection(verts, facecolors='r', edgecolor='none'))
            # Draw bottom cap
            axes.add_collection3d(Poly3DCollection([bottom_circle], facecolors='r', edgecolor='none'))
            # Draw top cap
            axes.add_collection3d(Poly3DCollection([top_circle], facecolors='r', edgecolor='none'))
...
if os.path.isdir(Fractal):
    ...
    if fname.lower().endswith(".txt"):
        ...
        for i in range(len(x) - 1):
            ...
            verts.append([bottom_circle[-1], bottom_circle[0], top_circle[0], top_circle[-1]])
            # Draw side surface
            axes.add_collection3d(Poly3DCollection(verts, facecolors='b', edgecolor='none'))
            # Draw bottom cap
            axes.add_collection3d(Poly3DCollection([bottom_circle], facecolors='b', edgecolor='none'))
            # Draw top cap
            axes.add_collection3d(Poly3DCollection([top_circle], facecolors='b', edgecolor='none'))
