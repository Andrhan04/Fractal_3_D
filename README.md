...
6. Для статистического анализа запустите скрипты из папки Statistics:
   ...
   - Get_proections.py — создание проекций частиц, фрактала и буфера на плоскости OXY, OXZ, OYZ
   - Get_gif_proections.py — создание анимированного GIF из проекций

## Новые возможности визуализации

### Проекции на плоскости
Скрипт [Get_proections.py](file:///c:/Users/user/source/Fractal_3_D/Statistics/Get_proections.py) создает визуализации проекций:
- **Проекции на OXY, OXZ, OYZ плоскости** — отображение частиц, фрактала и буфера
- **Цветовая схема**: частицы - зеленый, фрактал - синий, буфер - красный
...
- **3D визуализация** с прозрачными фракталом и буфером

### Анимация проекций
Скрипт [Get_gif_proections.py](file:///c:/Users/user/source/Fractal_3_D/Statistics/Get_gif_proections.py) создает анимированные GIF:
- Автоматическая сортировка файлов проекций по номеру шага
- Оптимизированная анимация с настройкой длительности кадров
- Сохранение в папку `../images/Experiment_{id}/`

### Русскоязычный интерфейс
Все гистограммы и визуализации теперь содержат русскоязычные подписи и метки
